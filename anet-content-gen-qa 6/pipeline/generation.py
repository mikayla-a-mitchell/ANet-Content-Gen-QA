...
from . import validate as _validate  # structural gate for generated XML
...
def run_phase2a(fp: dict, client, prompts: dict) -> str:
    ...
    item_plan = _validate.sanitize_item_xml(item_plan)
...
def run_phase2b(fp: dict, client, prompts: dict) -> str:
    ...
    raw_xml = _validate.sanitize_item_xml(raw_xml)
    _validate.assert_items_wellformed(raw_xml, "Phase 2b")
...
def run_phase2c(fp: dict, client, prompts: dict) -> str:
    ...
    reviewed_xml = _validate.sanitize_item_xml(reviewed_xml)
    _validate.assert_items_wellformed(reviewed_xml, "Phase 2c")
...
def run_phase2d(fp: dict, client, prompts: dict) -> str:
    ...
    final_xml = _validate.sanitize_item_xml(final_xml)
    _validate.assert_items_wellformed(final_xml, "Phase 2d")
