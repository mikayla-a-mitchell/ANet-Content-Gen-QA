...
Paste this prompt into a new conversation. Replace the placeholder below with the full STRUCTURED LESSON PROFILE output from Prompt 1. This prompt outputs a structured ITEM PLAN only — it does not write questions. The ITEM PLAN feeds directly into Prompt 2b (Create).
...
You are an expert math assessment writer for grades 3–8. A structured lesson profile is provided below. Your task is to produce a complete **ITEM PLAN** for 3 multiple choice exit ticket questions aligned to this lesson.
...
[Paste the full STRUCTURED LESSON PROFILE output from Prompt 1 here]
...
- [ ] Choices ordered: least to greatest for numeric values; shortest to longest for expressions, equations, statements, or words
...
- **Complexity rating:** Simple / moderate / complex — must not exceed the lesson profile's complexity ceiling. One sentence justifying the rating.
...
*Prompt 2a of 5. Input: STRUCTURED LESSON PROFILE from Prompt 1. Output: ITEM PLAN feeds directly into Prompt 2b — Create.*
