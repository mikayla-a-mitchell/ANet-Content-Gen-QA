...
Paste this prompt into a new conversation. Replace the placeholder below with the full EXIT_TICKET XML output from Prompt 2c. This prompt runs every bias, sensitivity, and language quality check, makes corrections, and outputs a clean final EXIT_TICKET XML ready for Phase 3 rendering.
...
You are an expert editor specializing in bias, accessibility, and language quality for K–8 math assessment items. A content-reviewed EXIT_TICKET XML block is provided below. Your task is to run every check in this prompt, fix any failures, and output a clean final EXIT_TICKET XML.
...
[Paste the full EXIT_TICKET XML output from Prompt 2c here]
...
*Prompt 2d of 5. Input: content-reviewed EXIT_TICKET XML from Prompt 2c. Output: final EXIT_TICKET XML feeds directly into Phase 3 — Render.*
